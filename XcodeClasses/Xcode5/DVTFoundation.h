...
// UUID: 0A741F53-AF27-3025-8372-F00119F6CC7D
//
//                           Arch: x86_64
...
- (void)observerServiceNamed:(NSString *)arg1 parentPid:(int)arg2 args:(NSArray *)arg3 env:(NSDictionary *)arg4 startSuspended:(BOOL)arg5;
@end
...
- (BOOL)launchRunningTerminationHandlerOnQueue:(struct dispatch_queue_s *)arg1 error:(id *)arg2 terminationHandler:(CDUnknownBlockType)arg3;
...
- (void)installEventHandlersForChildPID:(int)arg1 queue:(struct dispatch_queue_s *)arg2 terminationHandler:(CDUnknownBlockType)arg3;
...
- (void)addAssociate:(id)arg1 withRole:(id)arg2 observingDidChangeRecursively:(BOOL)arg3 onDispatchQueue:(struct dispatch_queue_s *)arg4 block:(CDUnknownBlockType)arg5;
...
- (void)startHandlingResponsesAsynchronouslyOnQueue:(struct dispatch_queue_s *)arg1 handler:(CDUnknownBlockType)arg2;
...
- (void)_asynchronouslyReceiveDataOfLength:(unsigned long long)arg1 queue:(struct dispatch_queue_s *)arg2 handler:(CDUnknownBlockType)arg3;
- (BOOL)sendData:(id)arg1 error:(id *)arg2;
- (void)_asynchronouslySendData:(id)arg1 queue:(struct dispatch_queue_s *)arg2 handler:(CDUnknownBlockType)arg3;
