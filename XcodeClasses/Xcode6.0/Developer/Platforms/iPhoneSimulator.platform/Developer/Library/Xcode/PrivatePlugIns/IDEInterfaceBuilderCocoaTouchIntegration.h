...
// UUID: D1E18D8E-23BE-30DE-8DC0-3F692D1E621F
//
//                           Arch: x86_64
//                Current version: 6238.0.0
//          Compatibility version: 1.0.0
//                 Source version: 6238.0.0.0.0
...
- (void)sendDebugRequestsForView:(id)arg1 marshalledRepresentation:(id)arg2 tool:(id)arg3;
...
- (id)attachToToolProxyForScaleFactor:(id)arg1 isForLiveViews:(BOOL)arg2 assertOnFailureToAttach:(BOOL)arg3 assertOnPostLaunchRequestFailures:(BOOL)arg4 error:(id *)arg5;
- (id)toolProxyManager;
...
- (id)cachedCocoaTouchRequestProxyAttachingIfNeededForTargetRuntime:(id)arg1 scaleFactor:(id)arg2 backgroundOperationIdentifier:(id)arg3 returningFailedLoadResult:(id *)arg4;
@end
...
@interface NSImage (IBDefaultValueMarshalling)
- (id)defaultDesignTimeMarshallerReferencingGlobalContext:(id)arg1;
@end
...
- (id)cocoaTouchToolForTargetRuntime:(id)arg1 scaleFactor:(id)arg2 error:(id *)arg3;
