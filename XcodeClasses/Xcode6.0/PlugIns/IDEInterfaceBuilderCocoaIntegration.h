...
// UUID: E0F165BC-BFB6-3232-9444-A94FD3333293
//
//                           Arch: x86_64
...
- (id)attachToToolForTargetRuntime:(id)arg1 isForLiveViews:(BOOL)arg2 scaleFactor:(id)arg3 assertOnFailureToAttach:(BOOL)arg4 assertOnPostLaunchRequestFailures:(BOOL)arg5 error:(id *)arg6;
...
@interface IBDocumentArchivingSchemaBitmaskComponent_IBButtonCellBehavior : IBDocumentArchivingSchemaBitmaskComponent
{
}
...
@interface IBDocumentArchivingSchemaClassComponent_IBNSCustomObjectDocumentArchiving_NSCustomObject : IBDocumentArchivingSchemaClassComponent
{
}
...
@interface IBDocumentArchivingSchemaEnumerationComponent_IBButtonCellType : IBDocumentArchivingSchemaEnumerationComponent
{
}
...
@interface IBNSTabViewControllerDropTargetResolver : IBNSViewDropTargetResolver
{
}
...
- (void)ibRemoveChildren:(id)arg1;
- (void)ibPopulateChildRelationOrder:(id)arg1;
- (id)prototypeSegementStyleEnumerationsValues;
- (id)prototypeSegementStyleEnumerationsDisplayNames;
- (BOOL)shouldDisplayPrototypeSegmentStyles;
