...
// UUID: A4119FEC-D1F7-3E17-951E-63DC2A11EA21
//
//                           Arch: x86_64
...
@property(readonly) __weak DVTDevice *device;
...
- (struct CGRect)_valueContainerForOriginX:(double)arg1 forOriginY:(double)arg2;
...
@interface DVTDeviceContentSplitView : NSSplitView
{
}
...
@interface _DVTTableCellViewTextField : NSTextField
{
}
...
@interface _DVTTableCellViewTextFieldCell : NSTextFieldCell
{
}
...
+ (id)_xcodeBundleIconForIconName:(id)arg1;
...
{
    DVTFilterToken *_representedObject;
}

@property(nonatomic) __weak DVTFilterToken *representedObject; // @synthesize representedObject=_representedObject;
- (void).cxx_destruct;
...
@interface DVTDiffSession : NSObject <DVTInvalidation>
{
    ...
    // Error parsing type: AB, name: _needsUpdate
    BOOL _inMergeEdit;
...
@property(readonly) __weak DVTDevice *device; // @synthesize device=_device;
- (void).cxx_destruct;
@property(readonly, getter=isGroupItem) BOOL groupItem;
@property(readonly, getter=isLeaf) BOOL leaf;
@property(readonly, getter=isEditable) BOOL editable;
...
- (void)_performAction:(id)arg1 onDevice:(id)arg2;
