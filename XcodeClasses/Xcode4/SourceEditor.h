...
// UUID: 4F315A36-34C2-35C2-A78C-847F3CB46518
//
//                           Arch: x86_64
//                Current version: 1.0.0
//          Compatibility version: 1.0.0
//                 Source version: 13140.21.0.0.0
...
@interface _TtC12SourceEditor16SourceEditorView : NSView <NSTextInputClient, NSServicesMenuRequestor>
{
    ...
    // Error parsing type: , name: preventRangeSelection
    // Error parsing type: , name: autoScrollToSelection
    ...
    // Error parsing type: , name: selectedSourceRange
...
- (void)selectedSourceRangeChanged;
- (void)selectedSourceRangeWillChange;
@property(nonatomic) BOOL isEditingEnabled; // @synthesize isEditingEnabled;
@property(nonatomic) BOOL delimiterHighlightEnabled;
- (void)pushReplaceStringForFindQuery;
- (void)pullReplaceStringForFindQuery;
- (void)pushFindStringFromFindQuery;
- (void)pullFindStringForFindQuery;
...
//@property(nonatomic, readonly) _TtC12SourceEditor18SourceEditorGutter *gutter; // @synthesize gutter;
...
@property(nonatomic) BOOL autoScrollToSelection; // @synthesize autoScrollToSelection;
@property(nonatomic) BOOL preventRangeSelection; // @synthesize preventRangeSelection;
...
- (void)continueMouseSelectionWith:(id)arg1;
- (void)rightMouseDown:(id)arg1;
- (void)mouseDown:(id)arg1;
- (BOOL)showMenuForEvent:(id)arg1;
...
- (void)unmarkText;
- (void)setMarkedText:(id)arg1 selectedRange:(struct _NSRange)arg2 replacementRange:(struct _NSRange)arg3;
- (void)insertText:(id)arg1 replacementRange:(struct _NSRange)arg2 allowCodeCompletion:(BOOL)arg3;
- (void)insertText:(id)arg1 replacementRange:(struct _NSRange)arg2;
...
@interface _TtC12SourceEditor22SourceEditorDataSource : SwiftObject
{
    ...
    // Error parsing type: , name: shouldVerifyLineIntegrity
}
...
@interface _TtC12SourceEditor20SelectionManagerImpl : SwiftObject
{
...
@interface _TtC12SourceEditorP33_7B2C24107EA613A78BE281DCE849218A35CursorTextAttributeOverrideProvider : SwiftObject
{
...
@interface _TtC12SourceEditorP33_7B2C24107EA613A78BE281DCE849218A38SelectionTextAttributeOverrideProvider : SwiftObject
{
    // Error parsing type: , name: selectionInfo
    // Error parsing type: , name: previousSelectionInfo
}
...
@interface _TtC12SourceEditor13TextFindField : NSSearchField
{
...
@interface _TtC12SourceEditor17TextFindFieldCell : NSSearchFieldCell
{
}
...
@interface _TtC12SourceEditor16TextReplaceField : NSTextField
{
    // Error parsing type: , name: panel
}
...
@interface _TtC12SourceEditor20TextReplaceFieldCell : NSTextFieldCell
{
}
...
- (void)updateNextPreviousDoneControl;
- (void)updateMatchesLabel;
- (void)updateRegularExpressionButton;
- (void)updateCaseSentivityButton;
- (void)updateReplaceField;
- (void)updateFindField;
- (void)regularExpressionButtonAction:(id)arg1;
- (void)matchCaseButtonAction:(id)arg1;
- (void)replaceAction:(id)arg1;
- (void)nextPrevDoneSegmentAction:(id)arg1;
- (void)controlTextDidEndEditing:(id)arg1;
- (void)controlTextDidChange:(id)arg1;
- (void)updateFindFieldInsets;
- (void)toggleFindReplaceMode:(id)arg1;
- (BOOL)validateMenuItem:(id)arg1;
@property(nonatomic, retain) NSMenu *findFieldMenuTemplate;
- (BOOL)becomeFirstResponder;
@property(nonatomic, readonly) BOOL acceptsFirstResponder;
- (void)performTextFinderAction:(id)arg1;
...
@property(nonatomic) __weak NSButton *regularExpressionButton; // @synthesize regularExpressionButton;
@property(nonatomic) __weak NSButton *caseSensitiveButton; // @synthesize caseSensitiveButton;
@property(nonatomic) __weak NSSegmentedControl *replaceControl; // @synthesize replaceControl;
@property(nonatomic) __weak NSSegmentedControl *nextPreviousDoneControl; // @synthesize nextPreviousDoneControl;
...
@interface _TtC12SourceEditor16RenameController : SwiftObject
{
    ...
    // Error parsing type: , name: consumeNextMouseUp
}
