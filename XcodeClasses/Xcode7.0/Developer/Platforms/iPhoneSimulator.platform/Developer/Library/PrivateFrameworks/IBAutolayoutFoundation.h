...
//
// File: /Applications/Xcode-7GM.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/Library/PrivateFrameworks/IBAutolayoutFoundation.framework/IBAutolayoutFoundation
// UUID: 306215AF-4E2B-3AF6-9700-4A8EC0E1C078
//
//                           Arch: x86_64
...
- (_Bool)applyMiddlingRuleToSelectionRect:(struct CGRect)arg1 rectToCenterTo:(struct CGRect)arg2 knobPosition:(CDUnion_42e99c75)arg3 snapDistance:(double)arg4 displayOnly:(_Bool)arg5 applicationState:(id)arg6;
- (_Bool)applyCenteringRuleToSelectionRect:(struct CGRect)arg1 rectToCenterTo:(struct CGRect)arg2 knobPosition:(CDUnion_42e99c75)arg3 snapDistance:(double)arg4 displayOnly:(_Bool)arg5 applicationState:(id)arg6;
- (_Bool)applyMiddlingRuleToSelectionRect:(struct CGRect)arg1 centeringRectForSelectionRect:(struct CGRect)arg2 rectToCenterTo:(struct CGRect)arg3 knobPosition:(CDUnion_42e99c75)arg4 snapDistance:(double)arg5 displayOnly:(_Bool)arg6 applicationState:(id)arg7;
- (_Bool)applyCenteringRuleToSelectionRect:(struct CGRect)arg1 centeringRectForSelectionRect:(struct CGRect)arg2 rectToCenterTo:(struct CGRect)arg3 knobPosition:(CDUnion_42e99c75)arg4 snapDistance:(double)arg5 displayOnly:(_Bool)arg6 applicationState:(id)arg7;
