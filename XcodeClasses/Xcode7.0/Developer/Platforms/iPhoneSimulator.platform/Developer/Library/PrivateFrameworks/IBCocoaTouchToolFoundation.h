...
//
// File: /Applications/Xcode-7GM.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/Library/PrivateFrameworks/IBCocoaTouchToolFoundation.framework/IBCocoaTouchToolFoundation
// UUID: 7AA351D2-DC22-3B79-AA70-8C0307F3CA45
//
//                           Arch: x86_64
...
+ (id)simulatedSearchBarStyleWithStyle:(long long)arg1 translucent:(_Bool)arg2 prompt:(_Bool)arg3 tintColor:(struct UIColor *)arg4 barTintColor:(struct UIColor *)arg5;
+ (id)defaultMetrics;
@property(readonly, copy, nonatomic) UIColor *barTintColor; // @synthesize barTintColor=_barTintColor;
@property(readonly, copy, nonatomic) UIColor *tintColor; // @synthesize tintColor=_tintColor;
@property(readonly, nonatomic, getter=isPrompted) _Bool prompted; // @synthesize prompted=_prompted;
...
+ (id)simulatedTabBarMetricsWithStyle:(long long)arg1 translucent:(_Bool)arg2 tintColor:(struct UIColor *)arg3 barTintColor:(struct UIColor *)arg4;
+ (id)defaultMetrics;
@property(readonly, copy, nonatomic) UIColor *barTintColor; // @synthesize barTintColor=_barTintColor;
@property(readonly, copy, nonatomic) UIColor *tintColor; // @synthesize tintColor=_tintColor;
@property(readonly, nonatomic, getter=isTranslucent) _Bool translucent; // @synthesize translucent=_translucent;
