...
//
// File: /Applications/Xcode-7GM.app/Contents/Developer/Platforms/WatchSimulator.platform/Developer/SDKs/WatchSimulator.sdk/Developer/Library/PrivateFrameworks/ScriptProcessor.framework/ScriptProcessor
// UUID: 164D8A82-8B5B-3D3E-B596-005FBB6DBA04
//
//                           Arch: i386
...
@interface ScriptAgent : NSObject <ScriptAgentAuthorizedAPI, UIARecorderDelegate>
{
    ...
    unsigned int _scriptStatus;
    unsigned int _bundleStatus;
...
- (void)setBundleStatus:(unsigned int)arg1;
- (void)setScriptStatus:(unsigned int)arg1;
- (void)heartbeat;
- (void)dealloc;
...
+ (_Bool)decomposeBacktraceLine:(id)arg1 intoFileURL:(id *)arg2 andLineNumber:(int *)arg3;
