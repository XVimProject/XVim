...
//
// File: /Applications/Xcode-7GM.app/Contents/Developer/Platforms/WatchSimulator.platform/Developer/SDKs/WatchSimulator.sdk/Developer/Library/PrivateFrameworks/DVTInstrumentsUtilities.framework/DVTInstrumentsUtilities
// UUID: E185E4ED-41ED-30ED-90F9-C14469A257F7
//
//                           Arch: i386
...
- (void)logAnamolousErrorMessageWithFormat:(NSString *)arg1 args:(char *)arg2;
- (void)logAnamolousErrorMessageWithFormat:(NSString *)arg1;
- (unsigned int)respondToFatalError:(NSError *)arg1 from:(id)arg2;
@end
...
- (unsigned long)_queryRange:(struct _XRIndexRange)arg1;
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;
- (id)copyWithZone:(struct _NSZone *)arg1;
- (void)dealloc;
...
- (id)objectForIntegerKey:(unsigned long long)arg1 options:(unsigned int)arg2;
- (id)objectForIntegerKey:(unsigned long long)arg1;
...
- (id)afterOperation:(id)arg1 priority:(int)arg2 spaceBlock:(CDUnknownBlockType)arg3;
- (id)afterOperations:(id)arg1 priority:(int)arg2 spaceBlock:(CDUnknownBlockType)arg3;
...
- (void)_mergeRangesFromIndex:(unsigned long)arg1;
- (void)_insertRange:(struct _XRIndexRange)arg1 atIndex:(unsigned long)arg2;
- (void)growArray;
...
@interface XRRecentArray : NSObject
{
    ...
    unsigned int _maximumRecentCount;
...
- (id)entries;
- (void)removeEntryAtIndex:(unsigned int)arg1;
- (void)removeEntry:(id)arg1;
- (void)addEntry:(id)arg1;
@property(nonatomic) unsigned int maximumRecentCount;
- (id)initWithMaximumRecentCount:(unsigned int)arg1;
- (id)init;
...
- (void)dealloc;
- (id)initWithMaximumRecentCount:(unsigned int)arg1 preferencePath:(id)arg2;
...
- (void).cxx_destruct;
- (id)copyWithZone:(struct _NSZone *)arg1;
- (id)initWithSpaceTag:(id)arg1 sequenceID:(unsigned int)arg2;
- (_Bool)isEqual:(id)arg1;
- (unsigned int)hash;
...
+ (id)defaultResponder;
+ (void)initialize;
- (void)logAnamolousErrorMessageWithFormat:(id)arg1 args:(char *)arg2;
- (void)logAnamolousErrorMessageWithFormat:(id)arg1;
- (unsigned int)respondToFatalError:(id)arg1 from:(id)arg2;
